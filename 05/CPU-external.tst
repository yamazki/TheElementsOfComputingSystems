...
set instruction %B1110001100001000, // M=D M[1000] = 11111
tick, output, tock, output;

set instruction %B0000001111101001, // @1001
tick, output, tock, output;

set instruction %B1110001110011000, // MD=D-1 M[1001] = 11110, D=11110
tick, output, tock, output;

set instruction %B0000001111101000, // @1000
tick, output, tock, output;

set instruction %B1111010011010000, // D=D-M D = D-M[1000] = 11111 - 11111 = 0
set inM 11111,
tick, output, tock, output;
